...
정책브리핑 API 제공 시작일(`1999-02-18`)부터 현재 백필 기준일(`2026-04-18`)까지 metadata-only 정찰을 완료했습니다. 상세 통계는 [docs/backfill-expansion-probe.md](docs/backfill-expansion-probe.md), SQLite 적재·대조 결과는 [docs/probe-metadata-load-report.md](docs/probe-metadata-load-report.md), 다음 manifest 계획은 [docs/backfill-manifest-plan.md](docs/backfill-manifest-plan.md)에 보관합니다.
